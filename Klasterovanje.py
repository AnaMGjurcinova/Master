...
df_clean['R_Rank'] = pd.qcut(df_clean['Recency'], q=5, labels=[5,4, 3, 2, 1])
df_clean['F_Rank'] = pd.qcut(df_clean['Frequency'], q=5, labels=[1, 2, 3, 4,5])
df_clean['M_Rank'] = pd.qcut(df_clean['Monetary'], q=5, labels=[5,4,3,2,1])
